...
public class Level5Tester extends JPanel implements KeyListener {
    ...
    public void loadPolygon(int version){
        if(version == 1){
            COW7.Point[] points = new COW7.Point[5];
            points[0] = new Point(100, 100, Color.BLUE, 10);
            points[1] = new COW7.Point(400, 100, Color.GREEN, 10);
            points[2] = new COW7.Point(300, 400, Color.RED, 10);
            ...
            COW7.Point[] points = new Point[12];
            ...
            points[7] = new COW7.Point(100, 400, Color.ORANGE, 10);
            ...
            COW7.Point[] points = new COW7.Point[7];
            points[0] = new COW7.Point(100, 100, Color.YELLOW, 10);
            points[1] = new COW7.Point(400, 100, Color.GREEN, 10);
            points[2] = new COW7.Point(300, 200, Color.GREEN, 10);
            points[3] = new COW7.Point(500, 400, Color.GREEN, 10);
            points[4] = new COW7.Point(400, 500, Color.RED, 10);
            points[5] = new COW7.Point(200, 300, Color.RED, 10);
            points[6] = new COW7.Point(100, 400, Color.RED, 10);
    ...
    public void paint(Graphics g){
        ...
        g.drawString("H - Stretch Horizontally, V - Stretch Vertically, E - Dilate by 3 around (250,250), Q - Dilate by .5 around (250,250)", 0, 20);
